...
MODEL                = libdtwDistances
MODULES              = dtwDistances_rtwutil.c dtwDistances_initialize.c dtwDistances_terminate.c dtwDistances.c round.c createBitmap.c round80.c sum.c dtw.c repmat.c power.c pixels.c Compute_AbslAng_Chain.c correctCentroids.c anotherRotateImageWithoutImrotate.c dtwDistances_emxutil.c rt_nonfinite.c rtGetNaN.c rtGetInf.c 
MAKEFILE             = dtwDistances_rtw.mk
...
MODELLIB                  = libdtwDistances.so
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
RELATIVE_PATH_TO_ANCHOR   = /media/micky/WORK/eclipseluna/ATIBOJava/matlab
...
ADD_INCLUDES = \
	-I/media/micky/WORK/eclipseluna/ATIBOJava/matlab/codegen/dll/dtwDistances \
