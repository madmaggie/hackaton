;(deftemplate Character (declare (from-class Character)))

(deftemplate character
	(slot name (type STRING))
	(multislot centruMasa (type NUMBER))
	(multislot centruMasaModel (type NUMBER))
	(slot height (type NUMBER))
	(slot heightModel (type NUMBER))
	(slot width (type NUMBER))
	(slot widthModel (type NUMBER))
	(slot distX (type NUMBER))
	(slot distY (type NUMBER))
	(slot absAngleDist (type NUMBER))
	(slot distRot (type NUMBER))
)
